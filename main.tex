...
% \part{Example Part}
\input{content/chapters/1/introduction.tex}   % INCLUDE: 1 - introduction
\input{content/chapters/1/analysis.tex}       % INCLUDE: 1 - analysis
\input{content/chapters/1/project.tex}          % INCLUDE: 1 - project
\input{content/chapters/1/conclusion.tex}       % INCLUDE: 1 - conclusion
